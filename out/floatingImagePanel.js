...
exports.FloatingImagePanel = void 0;
const vscode = require("vscode");
class FloatingImagePanel {
    static createOrShow(extensionUri, imageUri) {
        ...
        const panel = vscode.window.createWebviewPanel('oiiaiFloatingImage', '🐱 Floating Image', { viewColumn: column, preserveFocus: true }, {
            enableScripts: true,
            localResourceRoots: [
                extensionUri,
                vscode.Uri.file('/')
...
exports.FloatingImagePanel = FloatingImagePanel;
//# sourceMappingURL=floatingImagePanel.js.map