...
class CatAudioPlayer {
    ...
    ensurePanel() {
        ...
        this.panel = vscode.window.createWebviewPanel('oiiaiAudio', 'OIIAI Audio', { viewColumn: vscode.ViewColumn.Beside, preserveFocus: true }, { enableScripts: true, localResourceRoots: [vscode.Uri.file(path.join(this.extensionPath, 'media'))] });
...
exports.CatAudioPlayer = CatAudioPlayer;
//# sourceMappingURL=catAudioPlayer.js.map